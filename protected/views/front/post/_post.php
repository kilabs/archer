<div class="col-md-6"><div class="listing clearfix is-verified is-premium">
      ...
      <div class="col-md-4 listing-image-outer">
        <a href="<?php echo Yii::app()->createUrl('post/detail',array('kategori'=>$data->kategori->slug,'id'=>$data->id,'slug'=>$data->slug ? $data->slug.'.html' : '-')); ?>" class="listing-image block">
      ...
      <div class="col-md-8">
        <div class="listing-info">
          <h4 class="roboto">
            <a href="<?php echo Yii::app()->createUrl('post/detail',array('kategori'=>$data->kategori->slug,'id'=>$data->id,'slug'=>$data->slug ? $data->slug.'.html' : '-')); ?>"><?php echo CHtml::encode($data->judul); ?></a>
          </h4>
          <p class="clearfix">
