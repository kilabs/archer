...
(function(f, s, d, undefined) {
    ...
    q = {
        ...
        getHtml: function() {
            ...
            if (1 < this.ln) {
                ...
                for (b = 0; b < this.ln; b += 1) this.ShowOnMenu(b) && (a += '<option value="' + (b + 1) + '">' + (this.o.locations[b].title || "#" + (b + 1)) + "</option>");
                a = f(a + "</select>").bind("change", function() {
                    c.ViewOnMap(this.value)
                })
            }(b =
                this.o.controls_title) && (b = f('<div class="controls_title"></div>').css(this.o.controls_applycss ? {
                fontWeight: "bold",
    ...
    n = {
        ...
        getHtml: function() {
            ...
            for (a = 0; a < this.ln; a++) this.ShowOnMenu(a) && c.append(f("<li></li>").append(n.html_a.call(this, a)));
